                        ...
                        <div className="container w-full max-w-[1700px] mx-auto">
                            <div className="flex flex-col items-center text-center pt-21 ">
                                ...
                                >
                                    ...
                                    <div className="flex-1  relative flex items-center gap-3 px-8 py-4 text-gray-700 font-semibold rounded-2xl overflow-hidden transition-all duration-300 hover:scale-105 shadow-lg  border border-white">
                                ...
                                >
                                    One card for all your global online payments. Secure, simple, and instantly
                                    available.
                                </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-25">
                            ...
                            >
                                ...
                                <div className="relative z-10 w-full pb-10">
                                    ...
                                    <p className=" text-center leading-relaxed">
                                        Control your recurring payments with dedicated cards for each subscription
                                        service.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            >
                                ...
                                <p className="text-gray-600 text-base text-left leading-relaxed">
                                    Get your virtual card instantly and start spending right away. No waiting, no
                                    delays.
                                </p>
                            </div>
                            ...
                            >
                                ...
                                <p className="text-gray-600 text-base text-left leading-relaxed">
                                    Bank-level encryption and fraud protection keep your transactions secure at all
                                    times.
                                </p>
                            </div>
                        </div>
